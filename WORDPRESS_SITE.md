...
1. Entre no cPanel → **Softaculous / Instalador de Aplicativos** → **WordPress** → _Install_.
...
No widget _Form_ → **Actions After Submit** → adicione **Webhook** →
`https://app.lz7energia.com.br/api/public/lead`

Nomeie os campos (aba _Advanced → ID_) exatamente assim:
