...
const pageQuery = { queryKey: ["site_page", "politica-de-privacidade"], queryFn: () => getPage({ data: { slug: "politica-de-privacidade" } }), staleTime: 5 * 60_000 };

const TITLE = "Política de Privacidade | LZ7 Energia";
const DESCRIPTION = "Como a LZ7 Energia coleta, usa e protege seus dados pessoais, conforme a LGPD.";
