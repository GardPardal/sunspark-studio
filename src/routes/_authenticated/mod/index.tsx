    ...
    <ModuleShell title="Sistema Operacional Comercial" subtitle="Escolha um módulo" active="">
      <div className="rounded-2xl border border-primary/15 bg-gradient-to-br from-primary/5 to-transparent p-5">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          CRM, Marketing, IA, BI, Financeiro e Administração. Nada foi substituído — tudo o que já
          funciona continua no mesmo lugar. Os módulos adicionam camadas de análise, saúde e
          inteligência sobre os dados existentes.
        </p>
      </div>
          ...
          <Link key={m.key} to={m.to} className="block">
            <Card className="p-4 hover:shadow-md transition h-full">
              <div className="flex items-start gap-3">
                <span
                  className={`grid h-11 w-11 place-items-center rounded-xl bg-muted/60 ${m.tone}`}
                >
