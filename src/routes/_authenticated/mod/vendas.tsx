...
export const Route = createFileRoute("/_authenticated/mod/vendas")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ecossistema financeiro: vendas, faturamento, recebido e a receber em um só lugar." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "robots", content: "noindex,nofollow" },
    ],
  }),
  component: VendasModule,
});
...
function VendasModule() {
  ...
  return (
    <ModuleShell title="Vendas & Faturamento" subtitle="Controle interno — fonte da verdade" active="vendas">
