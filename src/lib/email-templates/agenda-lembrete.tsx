...
const Email = ({
  ...
  <Html lang="pt-BR">
    <Head />
    <Preview>Lembrete: compromisso em 30 minutos</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={valueBold}>{fmt(starts_at)}</Text>
          <Hr style={hr} />
          <Text style={label}>Tipo</Text>
          <Text style={value}>{tipo}</Text>
          {lead_nome && (
            <>
              <Hr style={hr} />
              <Text style={label}>Lead</Text>
...
export const template = {
  component: Email,
  subject: "⏰ Compromisso em 30 min",
  displayName: "Agenda — lembrete",
  previewData: {
    consultor: "João",
    title: "Ligar Maria",
