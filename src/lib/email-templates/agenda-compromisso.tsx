...
const Email = ({
  ...
  <Html lang="pt-BR">
    <Head />
    <Preview>Novo compromisso na sua agenda LZ7</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Hr style={hr} />
          <Text style={label}>Fim</Text>
          <Text style={value}>{fmt(ends_at)}</Text>
          {lead_nome && (
            <>
              <Hr style={hr} />
...
export const template = {
  component: Email,
  subject: "📅 Novo compromisso na sua agenda",
  displayName: "Agenda — compromisso criado",
  previewData: {
    consultor: "João",
