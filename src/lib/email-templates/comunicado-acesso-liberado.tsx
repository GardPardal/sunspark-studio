    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={hero}>
          ...
          <Text style={heroSub}>
            Olá, {fullName}. Ajustamos a autenticação do painel — agora sua conta aprovada entra
            direto, sem erro de credenciais.
          </Text>
        </Section>
        ...
        <Section style={card}>
          ...
          <Text style={cardText}>
            Toda aprovação (por e-mail ou painel) agora confirma o login automaticamente. Nada de
        ...
        <Text style={muted}>
          Se ainda tiver qualquer dificuldade, use "Esqueci minha senha" na tela de login ou
...
const hero = {
  background: "linear-gradient(135deg, #0b1220 0%, #1e293b 55%, #f59e0b 140%)",
  borderRadius: "16px",
  padding: "32px 28px",
  color: "#ffffff",
};
