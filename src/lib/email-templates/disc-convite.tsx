  ...
  <Html lang="pt-BR" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={lead}>
          São cerca de {minutes} minutos, pelo celular mesmo. Não existe resposta certa ou errada —
          ela é complementar e não decide sozinha o resultado do processo.
        </Text>
        ...
        {expiresAt ? (
          <Text style={muted}>Este link é individual e vale até {expiresAt}.</Text>
        ) : null}
      </Container>
    </Body>
  </Html>
...
export const template = {
  component: Email,
  subject: (d: Record<string, any>) => `Avaliação comportamental — ${d.jobTitle ?? "LZ7 Energia"}`,
